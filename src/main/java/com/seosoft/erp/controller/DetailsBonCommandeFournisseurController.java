...
@Named
@SpringViewScoped
public class DetailsBonCommandeFournisseurController extends GenericCRUDController<DetailsBonCommandeFournisseur, DetailsBonCommandeFournisseurService> implements Serializable {
	private static final long serialVersionUID = 7838900790101299064L;

	protected void prepareData(){
		super.prepareData();
		_moduleName = "detailsBonCommandeFournisseur";
		prepareForCreateNew();
	}
	...
	public void prepareForCreateNew(){
		_object = new DetailsBonCommandeFournisseur();
	}
}
